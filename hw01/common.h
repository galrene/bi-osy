...
//=============================================================================================================================================================
/**
 * A simlpe representation of a time interval + the payment offered for the rent. 
 */
class CInterval {
public:
    //---------------------------------------------------------------------------------------------------------------------------------------------------------
...
public:
    //---------------------------------------------------------------------------------------------------------------------------------------------------------
    CProblem(int count,
             std::initializer_list<CInterval> intervals)
            : m_Count(count),
    ...
    //---------------------------------------------------------------------------------------------------------------------------------------------------------
    CProblem &add(const CInterval &interval) {
...
public:
    ...
    virtual AProblemPack waitForPack(void) = 0; // 1 vlakno

    virtual void solvedPack(AProblemPack pack) = 0; // 1 vlakno
};
